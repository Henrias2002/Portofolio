     ...
     return <div className={`min-h-screen max-w-screen relative  ${isOpen ? 'overflow-hidden':''}`}>
            ...
            <section id="home" className=" space-y-4 flex flex-col-reverse items-center lg:space-y-8 my-[50px] lg:my-[100px] py-8 lg:flex lg:flex-row lg:px-4 lg:items-center lg:justify-center ">
                <div className="flex flex-col items-center lg:bloc space-y-2 lg:space-y-8 px-4 mx-12 ">
                    <div className="">
                        <h2 className="text-lg lg:text-4xl lg:pl-1  text-orange-300 text-center lg:text-left ">Bonjour,  je suis</h2>
                        ...
                        <div className='flex lg:inline-flex gap-2 items-center flex-col md:flex-row py-3'>
                            ...
                            <div className="flex px-2 gap-3 justify-center items-center">
                                ...
                                <a href="#" className='duration-200 ease-in-out shadow-lg hover:drop-shadow-[0_0_10px_#00acee] hover:bg-[#00acee] p-1 flex justify-center items-center  rounded-full'>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="#" className='duration-200 ease-in-out shadow-lg hover:drop-shadow-[0_0_10px_#0077B5] hover:bg-[#0077B5] flex p-1 justify-center items-center  rounded-full'>
                                ...
                                <a href="#" className='duration-200 shadow-lg hover:drop-shadow-[0_0_10px_#494848] hover:bg-slate-900  p-[6px] flex justify-center items-center  rounded-full'>
